...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = "m1";
    public static String leftRearMotorName = "m0";
    public static String rightFrontMotorName = "m2";
    public static String rightRearMotorName = "m3";
    ...
    public static double forwardZeroPowerAcceleration = -55.64;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -95;
