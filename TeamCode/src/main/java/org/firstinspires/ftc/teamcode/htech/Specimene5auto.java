...
public class Specimene5auto extends LinearOpMode {
    ...
    public static int time_to_drop = 300;
    ...
    public static double COLLECTING_X = -20, COLLECTING_Y = 45, COLLECTING_ANGLE = 180;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            switch(CS) {
                ...
                case DROPPING:
                    follower.followPath(goToDrop);
                    CS = STATES.WAIT_CLESTE;
