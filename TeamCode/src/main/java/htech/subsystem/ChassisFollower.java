...
public class ChassisFollower {
    ...
    public ChassisFollower(HardwareMap hardwareMap) {
        // MOTOR DECLARATION //
...
//        rightRearMotor.setPower((-g.left_stick_y + g.left_stick_x - g.right_stick_x * rotationSpeed) * speed);
        follower.setTeleOpMovementVectors(-g.left_stick_y, -g.left_stick_x, -g.right_stick_x * rotationSpeed);
        follower.update();
    }
...
//        rightRearMotor.setPower((-g.left_stick_y + g.left_stick_x - g.right_stick_x * 0.3) * speed);
        follower.setTeleOpMovementVectors(-g.left_stick_y, -g.left_stick_x, -g.right_stick_x * 0.3);
        follower.update();
    }
