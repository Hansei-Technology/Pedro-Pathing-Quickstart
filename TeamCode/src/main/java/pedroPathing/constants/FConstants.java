...
public class FConstants {
    static {
        ...
        FollowerConstants.headingPIDFCoefficients = new CustomPIDFCoefficients(3.5,0,0.09,0);
        ...
        FollowerConstants.drivePIDFCoefficients = new CustomFilteredPIDFCoefficients(0.012,0,0.000002,0.6,0);
